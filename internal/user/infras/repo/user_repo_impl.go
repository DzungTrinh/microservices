...
//}
//
//func (r *userRepository) CreateRefreshToken(ctx context.Context, model dto.CreateRefreshTokenModel) error {
...
func (r *userRepository) CreateUser(ctx context.Context, user domain.User) error {
	err := r.Queries.CreateUser(ctx, mysql.CreateUserParams{
		ID:            user.ID,
		Email:         user.Email,
		Username:      user.Username,
	...
	if err != nil {
		r.logger.Errorf("Failed to create user %s: %v", user.ID, err)
		return err
	}
	return nil
}
