...
CREATE TABLE IF NOT EXISTS user_tenants (
    ...
    role        VARCHAR(50) NULL, -- optional membership role
    created_at  DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS users (
    ...
    UNIQUE KEY uniq_username_tenant(tenant_id, username),
...
CREATE TABLE IF NOT EXISTS credentials (
    ...
    UNIQUE KEY uniq_provider_uid (provider, provider_uid),
       UNIQUE KEY uniq_provider_uid_tenant (tenant_id, provider, provider_uid),
...
CREATE TABLE IF NOT EXISTS mfa_factors (
    ...
    deleted_at DATETIME    NULL,
        tenant_id     CHAR(36) NOT NULL,
        INDEX idx_mfa_tenant (tenant_id),
...
CREATE TABLE IF NOT EXISTS verification_tokens (
    ...
    INDEX idx_expires (expires_at),
        INDEX idx_vtoken_tenant(tenant_id),
...
CREATE TABLE IF NOT EXISTS roles (
    ...
    deleted_at DATETIME   NULL,
     tenant_id CHAR(36) NULL,     
      UNIQUE KEY uniq_role_name_tenant (tenant_id, name),
...
CREATE TABLE IF NOT EXISTS permissions (
    ...
    deleted_at DATETIME    NULL,
     tenant_id CHAR(36) NULL,   
      UNIQUE KEY uniq_perm_name_tenant (tenant_id, name),
...
CREATE TABLE IF NOT EXISTS user_permissions (
    ...
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (user_id, perm_id, tenant_id),
...
CREATE TABLE IF NOT EXISTS templates (
    ...
    deleted_at DATETIME    NULL,
     tenant_id  CHAR(36) NOT NULL,
     UNIQUE KEY uniq_template_name_tenant (tenant_id, name),
